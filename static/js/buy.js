const mainnetContract = "0x8dDE25F7df13a6ecbABf1891887cc1937a8c6bD1";
...
//const cost = "6000000000000000000";
...
async function mint_gas() {
  let totalToMint = document.getElementById("quantity").value;
  var web3 = new Web3(Web3.givenProvider);
  window.contract = await new web3.eth.Contract(mainnetAbi, mainnetContract);
  const transactionParameters = {
    to: mainnetContract,
